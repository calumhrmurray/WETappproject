...
namespace WETwebApp.Controllers
{
    public class DevelopersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DeveloperID,Type")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DeveloperID,Type")] Developer developer)
        {
            if (ModelState.IsValid)
            {
